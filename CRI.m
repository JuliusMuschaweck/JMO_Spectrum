classdef CRI < handle
    ...
    methods
        ...
        function PlotCRISpectra(this)
            ...
            hold on;
            for i=1:16
                plot(this.CRISpectra_(i).lam, this.CRISpectra_(i).val);
        ...
        function rv_struct = Test(this, doPrint)
            ...
            CIE_FL_targets = [76, 64, 57, 51, 72, 59, 90, 95, 90, 81, 83, 83];
            for i = 1:length(CIE_FL_targets)
                sn = sprintf('FL%i',i);
                res = iTestRa(CIE_Illuminant(sn), sn, CIE_FL_targets(i), 0.5);
                rv_struct{end+1} = res;
            end
            CIE_FL_3_targets = ...  % row index = Ri, col index = FL_3_j
            [42,65,	64,	91,	97,	97,	97,	94,	94,	99,	90,	95,	98,	93,	99;...
            69,	80,	80,	89,	97,	97,	94,	89,	89,	97,	86,	98,	97,	94,	99;...
            89,	89,	89,	79,	92,	93,	54,	50,	48,	63,	49,	92,	98,	97,	96;...
            39,	66,	69,	88,	94,	97,	88,	85,	84,	92,	82,	95,	97,	94,	98;...
            41,	66,	69,	88,	97,	97,	86,	83,	84,	92,	81,	94,	99,	94,	99;...
            52,	71,	74,	82,	95,	95,	81,	73,	72,	85,	70,	97,	97,	93,	100;...
            66,	79,	81,	88,	94,	96,	87,	86,	85,	92,	85,	93,	94,	97,	98;...
            13,	48,	49,	89,	94,	96,	64,	72,	78,	86,	79,	83,	88,	97,	98;...
            -109,-37,-63,76,88,	93,	-9,	5,  22,	46,	24,	58,	71,	93,	96;...
            29,	51,	52,	69,	90,	90,	51,	40,	38,	62,	34,	88,	99,	91,	99;...
            19,	56,	62,	88,	95,	97,	76,	68,	68,	78,	64,	93,	94,	95,	100;...
            21,	59,	68,	63,	90,	92,	50,	48,	51,	72,	50,	85,	89,	85,	95;...
            47,	68,	68,	91,	97,	98,	98,	95,	95,	97,	90,	97,	99,	92,	98;...
            93,	94,	93,	87,	95,	95,	69,	67,	66,	75,	67,	94,	98,	97,	98];
            for i = 1:15
                    sn = sprintf('FL3_%i',i);
                    res = iTestR1_14(CIE_Illuminant(sn), sn, CIE_FL_3_targets(:,i), 0.5);
                    rv_struct{end+1} = res;
            end            

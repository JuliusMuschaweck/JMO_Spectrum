...
% </html>
%
% Computes CIE1964 10° X, Y, Z tristimulus values and x, y, z color coordinates of a spectrum, and its color weight X+Y+Z
...
%% See also
% <CIE_Lab.html CIE_Lab>, <CIE_Luv.html CIE_Luv>, <CIE_upvp.html CIE_upvp>, <CIE1931_XYZ.html CIE1931_XYZ>, <IntegrateSpectrum.html IntegrateSpectrum>, 
% <LDomPurity.html LDomPurity>, <LinInterpol.html LinInterpol>, <MultiplySpectra.html MultiplySpectra>
%% Usage Example
% <include>Examples/ExampleCIE1964_XYZ.m</include>

% publish with publishWithStandardExample('filename.m') in PublishDocumentation.m

% JMO Spectrum Library, 2023. See https://github.com/JuliusMuschaweck/JMO_Spectrum
% I dedicate the JMO_Spectrum library to the public domain under Creative Commons Zero 
% (https://creativecommons.org/publicdomain/zero/1.0/legalcode)
%
function rv = CIE1964_XYZ(spec)
    % function rv = CIE1964_XYZ(spec)
    % compute CIE 1964 XYZ tristimulus and xy coords from spec.lam, spec.val
    ...
    persistent iXYZ;
    if isempty(iXYZ)
        % 21.8.24 JM: new official CIE data 
        iXYZ = CIE1964_Data();
        % before 21.8.24
    ...
    if (iXYZ.lam(2) - iXYZ.lam(1)) ~= 1
        error('CIE1964_XYZ: no unit spacing in CIE1964XYZ.lam');
    end
